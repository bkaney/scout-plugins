class E2CloudwatchElb < Scout::Plugin
  ...
  def build_report
    ...
    # Available measures for ELB instances:
    # HealthyHostCount Latency RequestCount UnHealthyHostCount
    measures=%w(HealthyHostCount Latency RequestCount UnHealthyHostCount)
    ...
    aws = CloudWatchElb::AWSAuthConnection.new(aws_access_key, aws_secret)
...
module CloudWatchElb
  ...
  RELEASE_VERSION = CloudWatchElb::VERSION::STRING
  ...
  #
  def CloudWatchElb.canonical_string(path)
    buf = ""
  ...
  #
  def CloudWatchElb.encode(aws_secret_access_key, str, urlencode=true)
  ...
  class AWSAuthConnection
    ...
    def get_aws_auth_param(path, aws_secret_access_key)
      canonical_string =  CloudWatchElb.canonical_string(path)
      encoded_canonical = CloudWatchElb.encode(aws_secret_access_key, canonical_string)
    end
  end
end
